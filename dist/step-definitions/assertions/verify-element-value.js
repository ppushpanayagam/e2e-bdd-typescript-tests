  ...
  var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(elementKey, negate, expectedElementValue) {
    ...
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        case 0:
          driver = this.screen.driver, globalConfig = this.globalConfig;
          console.log("the ".concat(elementKey, " should ").concat(negate ? 'not ' : '', "contain the value ").concat(expectedElementValue));
          _context6.next = 4;
          return (0, _webElementHelper.getElementLocator)(driver, elementKey, globalConfig);
        case 4:
            ...
            return _regeneratorRuntime().wrap(function _callee5$(_context5) {
              while (1) switch (_context5.prev = _context5.next) {
                ...
                case 6:
                  ...
                  return _context5.abrupt("return", (elementAttribute === null || elementAttribute === void 0 ? void 0 : elementAttribute.includes(expectedElementValue)) === !negate);
                case 8:
  ...
  var _ref7 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee8(elementKey, negate, expectedElementValue) {
    ...
    return _regeneratorRuntime().wrap(function _callee8$(_context8) {
      while (1) switch (_context8.prev = _context8.next) {
        case 0:
          driver = this.screen.driver, globalConfig = this.globalConfig;
          console.log("the ".concat(elementKey, " should ").concat(negate ? 'not ' : '', "equal the value ").concat(expectedElementValue));
          _context8.next = 4;
          return (0, _webElementHelper.getElementLocator)(driver, elementKey, globalConfig);
        case 4:
            ...
            return _regeneratorRuntime().wrap(function _callee7$(_context7) {
              while (1) switch (_context7.prev = _context7.next) {
                ...
                case 6:
                  ...
                  return _context7.abrupt("return", elementAttribute === expectedElementValue === !negate);
                case 8:
...
(0, _cucumber.Then)(/^the ([0-9]+th|[0-9]+st|[0-9]+nd|[0-9]+rd) "([^"]*)" should( not)? contain the text "(.*)"$/, /*#__PURE__*/function () {
  var _ref9 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee10(elementPosition, elementKey, negate, expectedElementText) {
            ...
            return _regeneratorRuntime().wrap(function _callee9$(_context9) {
              while (1) switch (_context9.prev = _context9.next) {
                ...
                case 6:
                  ...
                  return _context9.abrupt("return", (elementText === null || elementText === void 0 ? void 0 : elementText.includes(expectedElementText)) === !negate);
                case 8:
