...
(0, _cucumber.Then)(/^the ([0-9]+th|[0-9]+st|[0-9]+nd|[0-9]+rd) (?:tab|window) should( not)? contain the title "(.*)"$/, /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(pagePosition, negate, expectedTitle) {
    var _pagePosition$match;
    var driver, pageIndex;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          driver = this.screen.driver;
          console.log("the ".concat(pagePosition, " window|tab should ").concat(negate ? 'not ' : '', "contain the title ").concat(expectedTitle));
          pageIndex = Number((_pagePosition$match = pagePosition.match(/\d/g)) === null || _pagePosition$match === void 0 ? void 0 : _pagePosition$match.join('')) - 1;
          _context2.next = 5;
          return (0, _waitForBehavior.waitFor)( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
            ...
            return _regeneratorRuntime().wrap(function _callee$(_context) {
              while (1) switch (_context.prev = _context.next) {
                case 0:
                  _context.next = 2;
                  return (0, _htmlBehavior.getTitleWithinPage)(driver, pageIndex);
                case 2:
...
(0, _cucumber.Then)(/^the "([^"]*)" on the ([0-9]+th|[0-9]+st|[0-9]+nd|[0-9]+rd) (?:tab|window) should( not)? be displayed$/, /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(elementKey, pagePosition, negate) {
    var _pagePosition$match2;
    var driver, globalConfig, pageIndex, elementIdentifier;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          driver = this.screen.driver, globalConfig = this.globalConfig;
          console.log("the ".concat(elementKey, " on the ").concat(pagePosition, " tab should ").concat(negate ? 'not ' : '', "be displayed"));
          pageIndex = Number((_pagePosition$match2 = pagePosition.match(/\d/g)) === null || _pagePosition$match2 === void 0 ? void 0 : _pagePosition$match2.join('')) - 1;
          _context4.next = 5;
          ...
          return (0, _waitForBehavior.waitFor)( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
            ...
            return _regeneratorRuntime().wrap(function _callee3$(_context3) {
              while (1) switch (_context3.prev = _context3.next) {
                case 0:
                  _context3.next = 2;
                  return (0, _waitForBehavior.waitForSelectorOnPage)(driver, elementIdentifier, pageIndex);
                case 2:
...
(0, _cucumber.Then)(/^the "([^"]*)" on the ([0-9]+th|[0-9]+st|[0-9]+nd|[0-9]+rd) (?:tab|window) should( not)? contain the text "(.*)"$/, /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(elementKey, pagePosition, negate, expectedElementText) {
    var _pagePosition$match3;
    var driver, globalConfig, pageIndex, elementIdentifier;
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        case 0:
          driver = this.screen.driver, globalConfig = this.globalConfig;
          console.log("the ".concat(elementKey, " on the ").concat(pagePosition, " tab should ").concat(negate ? 'not ' : '', "contain the text ").concat(expectedElementText));
          pageIndex = Number((_pagePosition$match3 = pagePosition.match(/\d/g)) === null || _pagePosition$match3 === void 0 ? void 0 : _pagePosition$match3.join('')) - 1;
          _context6.next = 5;
          return (0, _webElementHelper.getElementLocator)(driver, elementKey, globalConfig);
        case 5:
...
(0, _cucumber.Then)(/^the "([^"]*)" on the ([0-9]+th|[0-9]+st|[0-9]+nd|[0-9]+rd) (?:tab|window) should( not)? equal the text "(.*)"$/, /*#__PURE__*/function () {
  var _ref7 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee8(elementKey, pagePosition, negate, expectedElementText) {
    var _pagePosition$match4;
    var driver, globalConfig, pageIndex, elementIdentifier;
    return _regeneratorRuntime().wrap(function _callee8$(_context8) {
      while (1) switch (_context8.prev = _context8.next) {
        case 0:
          driver = this.screen.driver, globalConfig = this.globalConfig;
          console.log("the ".concat(elementKey, " on the ").concat(pagePosition, " tab should ").concat(negate ? 'not ' : '', "equal the text ").concat(expectedElementText));
          pageIndex = Number((_pagePosition$match4 = pagePosition.match(/\d/g)) === null || _pagePosition$match4 === void 0 ? void 0 : _pagePosition$match4.join('')) - 1;
          _context8.next = 5;
          return (0, _webElementHelper.getElementLocator)(driver, elementKey, globalConfig);
        case 5:
