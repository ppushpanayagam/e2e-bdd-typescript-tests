      ...
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 4:
          ...
          return (0, _waitForBehavior.waitFor)( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
            var elementStable, tableData, table, table1, webTable, str, resultTable, i, _i, j;
            return _regeneratorRuntime().wrap(function _callee$(_context) {
              while (1) switch (_context.prev = _context.next) {
                ...
                case 2:
                  ...
                  _context.next = 6;
                  return (0, _htmlBehavior.getTableData)(driver, elementIdentifier);
                case 6:
                  tableData = _context.sent;
                  table = [];
                  table1 = tableData.split(",");
                  webTable = [];
                  dataTable.raw().map(function (data) {
                  ...
                  for (_i = 0; _i < resultTable.length; _i++) {
                    for (j = 0; j < table1.length; j++) {
                      if (resultTable[_i] == table1[j]) {
                        webTable.push(table1[j]);
                      }
                    }
                  }
                  return _context.abrupt("return", webTable.toString().trim() === resultTable.toString().trim() === !negate);
                case 16:
                case "end":
