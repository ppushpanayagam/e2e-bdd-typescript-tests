...
(0, _cucumber.Given)(/^I am on the "([^"]*)" page$/, /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(pageId) {
    var driver, globalConfig;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          driver = this.screen.driver, globalConfig = this.globalConfig;
          _context.next = 3;
          return (0, _navigationBehavior.navigateToPage)(driver, pageId, globalConfig);
        case 3:
          _context.next = 5;
          return (0, _waitForBehavior.waitFor)(function () {
            return (0, _navigationBehavior.currentPathMatchesPageId)(driver, pageId, globalConfig);
          });
        case 5:
        case "end":
...
(0, _cucumber.When)(/^I click the "([^"]*)" (?:button|link)$/, /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(elementKey) {
    var driver, globalConfig, elementIdentifier;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          driver = this.screen.driver, globalConfig = this.globalConfig;
          console.log("I click the ".concat(elementKey, " button|link"));
          _context3.next = 4;
          return (0, _webElementHelper.getElementLocator)(driver, elementKey, globalConfig);
        case 4:
          elementIdentifier = _context3.sent;
          _context3.next = 7;
          return (0, _waitForBehavior.waitFor)( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
            var elementStable;
            return _regeneratorRuntime().wrap(function _callee2$(_context2) {
              while (1) switch (_context2.prev = _context2.next) {
                ...
                case 6:
                  return _context2.abrupt("return", elementStable);
                case 7:
                case "end":
...
(0, _cucumber.When)(/^I click the "([^"]*)" screen$/, /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(elementKey) {
    var driver, globalConfig, elementIdentifier;
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          ...
          return (0, _webElementHelper.getElementLocator)(driver, elementKey, globalConfig);
        case 3:
          elementIdentifier = _context5.sent;
          _context5.next = 6;
            ...
            return _regeneratorRuntime().wrap(function _callee4$(_context4) {
              while (1) switch (_context4.prev = _context4.next) {
                ...
                case 2:
                  ...
                  return (0, _htmlBehavior.clickElement)(driver, elementIdentifier);
                case 6:
                  return _context4.abrupt("return", elementStable);
                case 7:
                case "end":
...
(0, _cucumber.When)(/^I am directed to "([^"]*)" page$/, /*#__PURE__*/function () {
  var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(pageId) {
    var driver, globalConfig;
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        case 0:
          driver = this.screen.driver, globalConfig = this.globalConfig;
          console.log("I click the ".concat(pageId, " button|link"));
          _context6.next = 4;
          return (0, _waitForBehavior.waitFor)(function () {
            return (0, _navigationBehavior.currentPathMatchesPageId)(driver, pageId, globalConfig);
          });
...
(0, _cucumber.Then)(/^I scroll to the "([^"]*)" (?:.*?)$/, /*#__PURE__*/function () {
  var _ref7 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee8(elementKey) {
    var driver, globalConfig, elementIdentifier;
    return _regeneratorRuntime().wrap(function _callee8$(_context8) {
      while (1) switch (_context8.prev = _context8.next) {
        case 0:
          driver = this.screen.driver, globalConfig = this.globalConfig;
          console.log("I scroll to the ".concat(elementKey));
          _context8.next = 4;
          return (0, _webElementHelper.getElementLocator)(driver, elementKey, globalConfig);
        case 4:
...
(0, _cucumber.Then)(/^the "([^"]*)" played automatically$/, /*#__PURE__*/function () {
  var _ref9 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee10(elementKey) {
    var driver, globalConfig, elementIdentifier;
